...
public class ProductController {
    ...
    public ResponseEntity<ApiResponseDto<List<ProductResponseDto>>> getProductsWithCategoryId(
        ...
        ApiResponseDto<List<ProductResponseDto>> response = new ApiResponseDto<>(200,
                ...
                productService.getAllProductsForUser(currentUserUtils.getRole(),categoryId,max,offset,sort,order,filters)
        );
    ...
    @GetMapping("/products")
    public ResponseEntity<ApiResponseDto<List<ProductResponseDto>>> getProductsForAdmin(
            @RequestParam(value = "max", defaultValue = "10") int max,
            @RequestParam(value = "offset", defaultValue = "0") int offset,
            @RequestParam(value = "sort", defaultValue = "id") String sort,
            @RequestParam(value = "order", defaultValue = "asc") String order,
        ...
        ApiResponseDto<List<ProductResponseDto>> response = new ApiResponseDto<>(200,
                "Products Retrieved Successfully",
                productService.getAllProductsForUser(currentUserUtils.getRole(),null,max,offset,sort,order,filters)
        );
